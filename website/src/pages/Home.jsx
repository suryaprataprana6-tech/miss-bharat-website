...
import { Crown, Star, Calendar, MapPin, CheckCircle2, Phone, ChevronRight, ChevronLeft, Award, Camera, TrendingUp, Tag, Globe, Sparkles } from 'lucide-react';
...
const Home = ({ handleOpenAssistant }) => {
  useEffect(() => {
    document.title = "Miss Bharat™ 2026 | National Beauty Pageant Registration India";
  }, []);
    ...
    <>
      ...
      <section id="faq" className="about" style={{ background: 'var(--gray-light)' }}>
        <div className="container" style={{ display: 'flex', justifyContent: 'center' }}>
          <div className="faq-compact-card">
            <Crown className="faq-card-icon" />
            <h2 className="faq-card-title">Frequently Asked Questions</h2>
            <p className="faq-card-subtitle">Ask Miss Bharat FAQ Assistant</p>
            <button 
              onClick={handleOpenAssistant}
              className="btn btn-primary faq-card-btn"
            >
              Open FAQ Assistant
            </button>
          </div>
